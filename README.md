...
```sh
pip install git+https://github.com/ralf-it/makefile-forces --verbose --force
```
...
Specify another branch:

```bash
curl https://raw.githubusercontent.com/ralf-it/makefile-forces/main/.install/install.sh | bash -s -- 1.0.0
```
