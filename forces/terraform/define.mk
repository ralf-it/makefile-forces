...
%+tf-imports: ## (forces/define/TF) Imports terraform for ENV & PLAYBOOK
	export ENVPLAYBOOK=$*
	export ENV=`echo $$ENVPLAYBOOK | cut -d'+' -f2`
	export PLAYBOOK=`echo $$ENVPLAYBOOK | cut -d'+' -f1`

	$(FORCES_TF_MAKE) __tf-imports__
...
%+tf-state-rm: clear ## (forces/define/TF) Remove tfstate for ENV & PLAYBOOK
	export ENVPLAYBOOK=$*
	export ENV=`echo $$ENVPLAYBOOK | cut -d'+' -f2`
	export PLAYBOOK=`echo $$ENVPLAYBOOK | cut -d'+' -f1`
...
%+tf-state-list: clear ## (forces/define/TF) List tfstate for ENV & PLAYBOOK
	export ENVPLAYBOOK=$*
	export ENV=`echo $$ENVPLAYBOOK | cut -d'+' -f2`
	export PLAYBOOK=`echo $$ENVPLAYBOOK | cut -d'+' -f1`

	$(FORCES_TF_MAKE) __tf-state-list__ $(ARGVN)
